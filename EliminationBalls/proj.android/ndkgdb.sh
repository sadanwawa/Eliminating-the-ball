APPNAME="EliminationBalls"
APP_ANDROID_NAME="com.EliminationBalls"

if [ -z "${SDK_ROOT+aaa}" ]; then
# ... if SDK_ROOT is not set, use "$HOME/bin/android-sdk"
    #SDK_ROOT="$HOME/bin/android-sdk"
    SDK_ROOT="/Users/yingchen/Desktop/Git-MinGame/AndroidTools/android-sdk-mac-x86_64"
fi

if [ -z "${NDK_ROOT+aaa}" ]; then
# ... if NDK_ROOT is not set, use "$HOME/bin/android-ndk"
    #NDK_ROOT="$HOME/bin/android-ndk"
    NDK_ROOT="/Users/yingchen/Desktop/Git-MinGame/AndroidTools/android-ndk-r9"
fi
